...
function PillarCard({
    ...
    return (
        <div style={{
            ...
            background: '#f8f9fb',
            borderRadius: 6,
            borderLeft: `4px solid ${badgeColor(ket)}`,
        }}>
            <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: '#1f3864' }}>{name}</div>
    ...
    return (
        <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 10 }}>
                ...
                <tbody>
                    {rows.map((row, i) => (
                        <tr key={i} style={{ background: row.below ? '#fff5f5' : i % 2 === 0 ? '#fff' : '#fafafa' }}>
