    ...
    return (
        <>
            <div className="flex justify-between items-start">
                ...
                <Button onClick={() => { setGroupName(""); setGroupDesc("");
                        setSubgroups([]); setShowModal(true);
                    ...
                    <div className={`bg-white rounded-2xl shadow-lg w-180 p-6 transform transition-all duration-200
                        ...
                        <form>
                            ...
                            <div className="flex justify-between items-center mb-3 mt-3">
                                ...
                                <Button className="flex items-center gap-1 border px-3 py-1 rounded-lg text-sm font-semibold
                                    hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
                                    onClick={(e) => { e.preventDefault(); handleAddSubgroup(); }} 
                            ...
                            {subgroups.map((subgroup, i) => (
                                <div key={i} className="border rounded-xl p-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input value={subgroup.text} onChange={(e) => handleSubgroupChange(i, e.target.value)}
                                            placeholder="Subgroup name"
                                            className="flex-1 border rounded-lg px-3 py-2 bg-gray-50"/>
                                        <Button onClick={() => handleDeleteSubgroup(i)}
