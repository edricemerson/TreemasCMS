...
function LegalEntity (){
    ...
    const fetchLegalEntities = async () => {
        try {
            const response = await fetch("/api/master-data/legal_entities");
    ...
    const handleSave = async () => {
        ...
        try {
            if (editingId) {
                // UPDATE (PUT)
                await fetch(`/api/master-data/legal_entities/${editingId}`, {
                    method: "PUT",
                ...
                // ADD NEW (POST)
                await fetch("/api/master-data/legal_entities", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(payload),
                });
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            await fetch(`/api/master-data/legal_entities/${id}`, {
                method: "DELETE",
            });
            fetchLegalEntities();
        } catch (error) {
