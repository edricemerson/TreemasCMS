...
//         try {
//             const response = await fetch("/api/master-data/financial_statuses");
...
//         try {
//             if (editingId) {
//                 await fetch(`/api/master-data/financial_statuses/${editingId}`, {
//                     method: "PUT",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
//             } else {
//                 await fetch("/api/master-data/financial_statuses", {
//                     method: "POST",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
...
//         try {
//             await fetch(`/api/master-data/financial_statuses/${id}`, { method: "DELETE" });
//             fetchFinancialStatuses();
//         } catch (error) {
