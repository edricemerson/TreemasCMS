...
function BusinessType (){
    ...
    const fetchBusinessTypes = async () => {
        try {
            const response = await fetch("/api/master-data/business-type");
  ...
  const handleSave = async () => {
        ...
        try {
            if (editingId) {
                ...
                await fetch(`/api/master-data/business-type/${editingId}`, {
                    method: "PUT",
                ...
                await fetch("/api/master-data/business-type", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(payload),
                });
 ...
 const handleDelete = async (id: number) => {
        ...
        try {
            ...
            await fetch(`/api/master-data/business-type/${id}`, {
                method: "DELETE",
            });
            fetchBusinessTypes(); 
        } catch (error) {
