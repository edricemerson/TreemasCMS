...
//         try {
//             const response = await fetch("/api/master-data/market_scopes");
...
//         try {
//             if (editingId) {
//                 await fetch(`/api/master-data/market_scopes/${editingId}`, {
//                     method: "PUT",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
//             } else {
//                 await fetch("/api/master-data/market_scopes", {
//                     method: "POST",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
...
//         try {
//             await fetch(`/api/master-data/market_scopes/${id}`, { method: "DELETE" });
//             fetchMarketScopes();
//         } catch (error) {
