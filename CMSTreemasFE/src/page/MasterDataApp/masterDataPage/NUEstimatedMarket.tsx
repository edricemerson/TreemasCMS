...
//         try {
//             const response = await fetch("/api/master-data/market_positions");
...
//         try {
//             if (editingId) {
//                 await fetch(`/api/master-data/market_positions/${editingId}`, {
//                     method: "PUT",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
//             } else {
//                 await fetch("/api/master-data/market_positions", {
//                     method: "POST",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify(payload),
//                 });
...
//         try {
//             await fetch(`/api/master-data/market_positions/${id}`, { method: "DELETE" });
//             fetchEstimatedMarkets();
//         } catch (error) {
