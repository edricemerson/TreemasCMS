...
function BusinessMaturity (){
    ...
    const fetchBusinessMaturities = async () => {
        try {
            const response = await fetch("/api/master-data/business-maturity");
    ...
    const handleSave = async () => {
        ...
        try {
            if (editingId) {
                // UPDATE (PUT)
                await fetch(`/api/master-data/business-maturity/${editingId}`, {
                    method: "PUT",
                ...
                // ADD NEW (POST)
                await fetch("/api/master-data/business-maturity", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                    body: JSON.stringify(payload),
                });
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            await fetch(`/api/master-data/business-maturity/${id}`, {
                method: "DELETE",
            });
            fetchBusinessMaturities();
        } catch (error) {
